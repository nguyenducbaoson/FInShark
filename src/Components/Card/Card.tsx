...
import AddPortfolios from '../Portfolio/AddPortfolio/AddPortfolio';
...
const Card: React.FC<Props> = (props: Props) : JSX.Element=> {
  return (
    <div
      ...
      id={props.id}
    >
      <Link to={`/company/${props.searchResult.symbol}/company-profile`} className="font-bold text-center text-black md:text-left">
